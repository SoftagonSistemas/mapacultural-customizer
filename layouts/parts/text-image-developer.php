...
<div class="text-image-feature w100">
    <div>
        ...
        <div class="grid-12">
            <entity-field :entity="entity" prop="developerTitle" class="col-12" :maxLength="65"></entity-field>
            <entity-field :entity="entity" prop="developerDescription" class="col-12" :maxLength="250"></entity-field>
        </div>
    </div>
